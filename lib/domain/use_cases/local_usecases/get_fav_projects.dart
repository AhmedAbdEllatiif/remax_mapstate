...
class GetFavProjects extends UseCase<List<FavProjectEntity>, NoParams> {
  ...
  @override
  Future<Either<AppError, List<FavProjectEntity>>> call(NoParams params) async => await localRepository.getFavoriteProjects();
