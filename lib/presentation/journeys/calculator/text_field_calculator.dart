...
import '../../../common/functions/get_current_app_language.dart';
...
class TextFieldCalculator extends StatelessWidget {
  ...
  const TextFieldCalculator({Key? key, required this.calculatorInputParams})
      : super(key: key);
      ...
      child: Stack(
        children: [
          ...
          if(calculatorInputParams.inputType !=
              CalculatorInputType.unitPrice && calculatorInputParams.inputType !=
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(Sizes.dimen_16.w),
                borderSide: const BorderSide(color: AppColor.white, width: 2.0),
              ),
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(Sizes.dimen_16.w),
                borderSide: BorderSide(
                    color: AppColor.white.withOpacity(0.4), width: 0.7),
              ),
